...
public class JNumberFormatField extends JTextField {
	...
	public JNumberFormatField(NumberFormat format) {
		...
		setHorizontalAlignment(LEFT);// documento respons�vel pela formata��o
		// do campo
		setDocument(new PlainDocument() {
			...
			public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
				String text = new StringBuilder(JNumberFormatField.this.getText().replaceAll("[^0-9]", ""))
				...
				super.insertString(0,
						numberFormat.format(new BigDecimal(
	...
	public static void main(String[] args) {
		...
		frame.add(new JNumberFormatField(new DecimalFormat("000000.00")) {
			{// limita a 4
				// caracteres
				setLimit(8);
			}
